...
<template>
    <div
        class="block md:flex justify-between items-center px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] pt-8">
        <div @click="$router.push(feature.href)" class="cursor-pointer block w-fit mx-auto md:mb-10 mb-[3rem]"
