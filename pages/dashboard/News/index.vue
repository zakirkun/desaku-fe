...
export default {
    ...
    methods: {
        async loadData() {
            ...
            const { data } = await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/news')
            this.items = data
        ...
        async addNews() {
            ...
            await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/news', {
                method: "POST",
                headers: {
        ...
        async removeNewsCategory() {
            await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/news-category/' + this.removedNewsCategoryId, {
                method: "DELETE",
                headers: {
                    Authorization: "Bearer " + useToken().token
                },
