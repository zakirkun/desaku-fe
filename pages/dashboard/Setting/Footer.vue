...
export default {
    ...
    methods: {
        async loadData() {
            const data = await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/footer')
            this.form = data
        },
        async loadSocialMedia() {
            const data = await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/social-media')
        ...
        async updateFooter() {
            ...
            await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/footer', {
                method: "PATCH",
                headers: {
        ...
        async updateSocialMedia() {
            await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/social-media', {
                method: "POST",
                headers: {
                    Authorization: "Bearer " + useToken().token
                },
