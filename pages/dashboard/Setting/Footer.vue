            ...
            <div class="card">
                ...
                <div class="mb-6 flex w-full items-center">
                    <div class="flex-auto grid grid-cols-2 gap-x-6">
                        ...
                        <v-text-field v-model="form.whatsapp" variant="outlined" hide-details="auto" placeholder="62897882637329"
                            label="Link"></v-text-field>
                    </div>
                </div>
                <Button @click="updateLocation" class="mt-1 bg-[#10B981] text-white px-3 py-2">
