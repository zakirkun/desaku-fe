        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="mt-5">
                    ...
                    <RichEditor v-if="renderRichEditor" :data="data.profile" @contentChange="contentChangeProfile" />
                </div>
                <div class="mt-5">
                    <div class="mb-5">
                        <span class="font-medium text-xl">Visi & Misi</span>
                    </div>
                    <RichEditor v-if="renderRichEditor" :data="data.visi" @contentChange="contentChangeVisi" />
                </div>
                <div class="mt-5">
                    <div class="mb-5">
                        <span class="font-medium text-xl">Tugas</span>
                    </div>
                    <RichEditor v-if="renderRichEditor" :data="data.tugas" @contentChange="contentChangeTugas" />
                </div>
                <v-btn @click="updateLembaga" color="#10B981" class="mt-5 text-white px-3 py-2">
