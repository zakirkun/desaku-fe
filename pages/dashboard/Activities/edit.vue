...
<template>
    ...
    <div class="grid animate-fade">
        <div class="col-12">
            <v-form ref="form">
                <div class="card">
                    <h3 class="text-2xl font-medium mb-5">Ubah Kegiatan</h3>
                    <div class="mb-8">
                        <v-text-field :rules="[v => !!v || 'Field is required']" v-model="form.title" variant="outlined"
                    ...
                    <v-btn @click="updateActivity" color="#10B981" class="mt-5 text-white px-3 py-2">
