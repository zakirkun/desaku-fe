...
export default {
    ...
    methods: {
        async loadData() {
            ...
            const data = await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/announcement')
            this.items = data
        ...
        async removeNews() {
            await $fetch(this.$config.public.PUBLIC_API_BASE_URL + '/api/announcement/' + this.removedAnnouncementId, {
                method: "DELETE",
                headers: {
