...
const __default__ = {
  ...
  async mounted() {
    const data = await $fetch(this.$config.public.API_PUBLIC_URL + "/api/image-gallery/" + this.$route.query.id);
  ...
  methods: {
    async updateImageHomepage() {
      ...
      this.loading = true;
      await $fetch(this.$config.public.API_PUBLIC_URL + "/api/image-gallery/" + this.$route.query.id, {
        headers: {
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="grid animate-fade"><div class="col-12"><div class="card"><h3 class="text-2xl font-medium mb-5">Edit Gambar Galeri</h3>`);
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_v_btn, {
        onClick: _ctx.updateImageHomepage,
        color: "#10B981",
        class: "mt-2 text-white px-3 py-2"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!_ctx.loading) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Gallery/image/edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit-22a0cd9b.mjs.map
