              ...
              _push2(ssrRenderComponent(unref(SwiperSlide), { class: "relative rounded-lg" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="rounded-lg text-sm sm:text-base font-normal rounded-b-md z-50 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white"${_scopeId2}><span${_scopeId2}>${ssrInterpolate(item.name)} - ${ssrInterpolate(item.job)}</span></div>`);
                  } else {
                    return [
                      ...
                      createVNode("div", { class: "rounded-lg text-sm sm:text-base font-normal rounded-b-md z-50 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white" }, [
...
//# sourceMappingURL=index-6cd38261.mjs.map
