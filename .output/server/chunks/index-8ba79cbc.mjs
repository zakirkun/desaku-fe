...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "animate-fade flex-1 block px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] pt-6" }, _attrs))} data-v-27b48c3a>`);
      _push(ssrRenderComponent(_component_BreadCrumb, null, {
        root: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-27b48c3a${_scopeId}>Kegiatan</span>`);
          } else {
            return [
      ...
      _push(`<div class="grid grid-cols-1 md:grid-cols-6 md:gap-x-12" data-v-27b48c3a><div class="block col-span-1 md:col-span-4" data-v-27b48c3a><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl sm:text-2xl font-semibold py-3" data-v-27b48c3a><span data-v-27b48c3a>Kegiatan `);
      if (unref(page) != 1) {
        _push(`<span data-v-27b48c3a>: Halaman ${ssrInterpolate(unref(page))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</span></div><!--[-->`);
      ssrRenderList(unref(news), (news2) => {
        _push(`<div class="cursor-pointer animate-fade flex mb-10" data-v-27b48c3a><div class="h-[120px] sm:h-[160px] w-[140px] sm:w-[220px] md:w-[260px] flex-none" data-v-27b48c3a>`);
        ...
        _push(`</div><div class="block pl-4" data-v-27b48c3a><div class="tetx-base md:text-xl font-semibold" data-v-27b48c3a><span class="line-clamp-2" data-v-27b48c3a>${ssrInterpolate(news2.title)}</span></div><div class="text-xs md:text-base block md:flex items-center font-medium mt-2" data-v-27b48c3a>`);
        _push(ssrRenderComponent(_component_IconsDate, null, null, _parent));
        _push(`<span class="ml-1 mr-2" data-v-27b48c3a>${ssrInterpolate(unref(moment)(news2.created_at).format("LL"))}</span></div><div class="mt-2 text-sm md:text-base" data-v-27b48c3a><span class="line-clamp-2 sm:line-clamp-3" data-v-27b48c3a>${ssrInterpolate(news2.description)}</span></div></div></div>`);
      });
      _push(`<!--]-->`);
      ...
      _push(`</div><div class="col-span-2" data-v-27b48c3a>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-27b48c3a"]]);

export { index as default };
//# sourceMappingURL=index-8ba79cbc.mjs.map
