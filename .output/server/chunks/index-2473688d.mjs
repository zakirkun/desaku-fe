  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_data_table, {
        ...
        "item.url": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<iframe class="my-6" width="260" height="165"${ssrRenderAttr("src", value)} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen${_scopeId}></iframe>`);
          } else {
            return [
              createVNode("iframe", {
                class: "my-6",
...
//# sourceMappingURL=index-2473688d.mjs.map
