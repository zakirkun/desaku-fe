...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="col-span-2"><div class="text-[#0088CC] border-[#0088CC] border-b-2 mt-5 mb-6 text-2xl font-semibold py-3"><span>Pengumuman Terbaru</span></div><div class="mb-3"><!--[-->`);
      ssrRenderList(_ctx.announcements, (announcement) => {
        _push(`<div class="cursor-pointer mb-1 px-2 py-3 flex"><div class="block"><div class="text-[#0088CC] text-md"><span>${ssrInterpolate(announcement.title)}</span></div><div class="mt-1"><span>${ssrInterpolate(unref(moment)(announcement.created_at).format("LL"))}</span></div></div></div>`);
      });
...
//# sourceMappingURL=index-d1f37433.mjs.map
