...
const __default__ = {
  ...
  async mounted() {
    const data = await $fetch(this.$config.public.API_PUBLIC_URL + "/api/jabatan/" + this.$route.query.id);
  ...
  methods: {
    async addJabatan() {
      ...
      this.loading = true;
      await $fetch(this.$config.public.API_PUBLIC_URL + "/api/jabatan/" + this.$route.query.id, {
        method: "PATCH",
        headers: {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Jabatan/edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit-a3b68d7a.mjs.map
