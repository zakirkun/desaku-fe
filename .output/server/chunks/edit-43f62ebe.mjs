...
import { resolveComponent, withCtx, createTextVNode, createVNode, openBlock, createBlock, useSSRContext, defineComponent, ref, createElementBlock } from 'vue';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="grid animate-fade"><div class="col-12"><div class="card"><h3 class="text-2xl font-medium mb-5">Ubah Berita</h3>`);
      _push(ssrRenderComponent(_component_v_form, { ref: "form" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid grid-cols-3 gap-3"${_scopeId}><div class="col-span-2"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_v_select, {
              ...
              "item-value": "uuid",
              "item-title": "name",
              modelValue: _ctx.form.category_id,
      ...
      _push(`<div class="mb-3 text-lg font-medium my-1">Thumbnail Berita</div>`);
...
//# sourceMappingURL=edit-43f62ebe.mjs.map
