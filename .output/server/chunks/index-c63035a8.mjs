...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-1 animate-fade block px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] pt-6" }, _attrs))} data-v-283a5330>`);
      _push(ssrRenderComponent(_component_BreadCrumb, null, {
        root: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-283a5330${_scopeId}>Potensi Desa</span>`);
          } else {
            return [
              createVNode("span", {
      ...
      _push(`<div class="grid grid-cols-1 md:grid-cols-6 md:gap-x-12 h-full" data-v-283a5330><div class="block col-span-1 md:col-span-4" data-v-283a5330><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3" data-v-283a5330><span data-v-283a5330>Potensi Desa</span></div>`);
      if (unref(potensi).length > 0) {
        _push(`<!--[-->`);
        ssrRenderList(unref(potensi), (potensi2) => {
          _push(`<div class="cursor-pointer flex mb-[0.5rem] md:mb-2 h-[160px] md:h-[200px]" data-v-283a5330><div class="h-[120px] sm:h-[160px] w-[140px] sm:w-[220px] md:w-[260px] flex-none" data-v-283a5330>`);
          ...
          _push(`</div><div class="block pl-4" data-v-283a5330><div class="tetx-base md:text-xl font-semibold" data-v-283a5330><span class="line-clamp-2" data-v-283a5330>${ssrInterpolate(potensi2.title)}</span></div><div class="block md:flex" data-v-283a5330><div class="text-xs md:text-base flex items-center font-medium mt-2" data-v-283a5330>`);
          _push(ssrRenderComponent(_component_IconsDate, null, null, _parent));
          _push(`<span class="ml-1" data-v-283a5330>${ssrInterpolate(unref(moment)(potensi2.created_at).format("LL"))}</span></div><div class="text-xs md:text-base flex items-center font-medium mt-2 sm:ml-2" data-v-283a5330>`);
          _push(ssrRenderComponent(_component_IconsTag, null, null, _parent));
          _push(`<span class="ml-1" data-v-283a5330>${ssrInterpolate(potensi2.category_name)}</span></div></div><div class="mt-2 text-sm md:text-base" data-v-283a5330><span class="line-clamp-2 sm:line-clamp-3" data-v-283a5330>${ssrInterpolate(potensi2.description)}</span></div></div></div>`);
        });
        _push(`<!--]-->`);
      } else {
        _push(ssrRenderComponent(_component_EmptyData, null, null, _parent));
      }
      _push(`</div><div class="col-span-2" data-v-283a5330>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-283a5330"]]);

export { index as default };
//# sourceMappingURL=index-c63035a8.mjs.map
