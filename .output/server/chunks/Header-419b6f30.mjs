...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex justify-between items-center mb-3"><div class="text-2xl font-semibold mb-2">Pengaturan Header</div></div><div class="grid animate-fade mb-6"><div class="col-12"><div class="card">`);
      ...
      if (_ctx.form.logo) {
        _push(`<div class="relative w-fit mt-4">`);
...
//# sourceMappingURL=Header-419b6f30.mjs.map
