import { _ as __nuxt_component_0 } from './MediaLibrary-4b789d30.mjs';
import { resolveComponent, withCtx, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, mergeProps } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
import { u as useHead, a as useToken, _ as _export_sfc } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './RichEditor-780d3c56.mjs';
import { _ as __nuxt_component_1$1 } from './Loader-d2c5798c.mjs';
...
const __default__ = {
  ...
  methods: {
    async addPotensi() {
      ...
      await $fetch(this.$config.public.API_PUBLIC_URL + "/api/potensi-desa", {
        method: "POST",
        headers: {
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconsMediaLibrary = __nuxt_component_1;
      ...
      _push(`<div class="grid animate-fade"><div class="col-12"><div class="card"><h3 class="text-2xl font-medium mb-5">Tambah Potensi Desa</h3>`);
            ...
            _push2(ssrRenderComponent(_component_v_btn, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_IconsMediaLibrary, null, null, _parent3, _scopeId2));
                  _push3(`<div class="ml-1 font-semibold"${_scopeId2}>Media Library</div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center" }, [
                      createVNode(_component_IconsMediaLibrary),
      ...
      if (_ctx.renderRichEditor) {
        _push(ssrRenderComponent(_component_RichEditor, { onContentChange: _ctx.contentChange }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_v_btn, {
        onClick: _ctx.addPotensi,
        color: "#10B981",
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Potensi-Desa/add.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=add-461ba49c.mjs.map
