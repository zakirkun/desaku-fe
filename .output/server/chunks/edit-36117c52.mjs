...
const __default__ = {
  ...
  methods: {
    async loadData() {
      const data = await $fetch(this.$config.public.API_PUBLIC_URL + "/api/lembaga/" + this.$route.query.id);
      this.form = data;
      this.data.tugas = data.tugas;
      this.data.visi = data.visi;
    ...
    async updateLembaga() {
      ...
      await $fetch(this.$config.public.API_PUBLIC_URL + "/api/lembaga/" + this.$route.query.id, {
        method: "PATCH",
        headers: {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Lembaga/edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit-36117c52.mjs.map
