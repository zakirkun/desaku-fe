...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const data = ([__temp, __restore] = withAsyncContext(() => $fetch("/api/kegiatan/slug/" + route.params.id)), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BreadCrumb, {
        ...
        root: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("span", {
                onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("/kegiatan")
              }, "Kegiatan", 8, ["onClick"])
            ];
          }
        }),
      ...
      _push(`<div class="pb-12 grid grid-cols-1 md:grid-cols-6 md:gap-x-12 gap-y-8"><div class="block col-span-1 md:col-span-4"><div class="text-[#0088CC] mb-2 text-2xl md:text-2xl font-semibold py-3"><span>${ssrInterpolate(unref(post).title)}</span></div><div class="text-md flex items-center font-medium mt-2 mb-4">`);
      _push(ssrRenderComponent(_component_IconsDate, null, null, _parent));
      _push(`<span class="ml-1">${ssrInterpolate(unref(moment)(unref(post).created_at).format("LL"))}</span></div><div class="quill-content">${unref(post).content}</div></div><div class="col-span-2">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Kegiatan/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-8c458504.mjs.map
