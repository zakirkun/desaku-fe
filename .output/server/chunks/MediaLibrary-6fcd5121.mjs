...
import { ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrRenderAttrs } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function onDrop(files) {
      ...
      loading.value = true;
      await $fetch("http://api.desaku.muhichsan.com/api/image", {
        body: formData,
        method: "POST"
      });
      setTimeout(async () => {
                ...
                if (_push3) {
                  ...
                  if (currentTab.value == "listImage") {
                    ...
                    if (imageSelected.value) {
                      _push3(`<img${ssrRenderAttr("src", imageSelected.value)}${_scopeId2}>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    ...
                    _push3(ssrRenderComponent(_component_v_btn, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 36 36"${_scopeId3}><path fill="white" d="M6 9v22a2.93 2.93 0 0 0 2.86 3h18.23A2.93 2.93 0 0 0 30 31V9Zm9 20h-2V14h2Zm8 0h-2V14h2Z" class="clr-i-solid clr-i-solid-path-1"${_scopeId3}></path><path fill="white" d="M30.73 5H23V4a2 2 0 0 0-2-2h-6.2A2 2 0 0 0 13 4v1H5a1 1 0 1 0 0 2h25.73a1 1 0 0 0 0-2" class="clr-i-solid clr-i-solid-path-2"${_scopeId3}></path><path fill="none" d="M0 0h36v36H0z"${_scopeId3}></path></svg>`);
                        } else {
                          return [
                            (openBlock(), createBlock("svg", {
                              xmlns: "http://www.w3.org/2000/svg",
                    ...
                    _push3(`</div></div><div class="w-full md:w-3/4 mt-10 md:mt-0 px-3 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-8"${_scopeId2}><!--[-->`);
                    ssrRenderList(images.value, (image) => {
                      _push3(`<div class="${ssrRenderClass([{ "border-4 border-[#10B981]": imageSelected.value == image }, "relative cursor-pointer h-[146px] items-center flex"])}"${_scopeId2}><img class="object-cover w-full" style="${ssrRenderStyle({ "height": "139px" })}"${ssrRenderAttr("src", image)}${_scopeId2}>`);
                      if (imageSelected.value == image) {
                        _push3(`<svg class="absolute right-[2px] top-0" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 16 16"${_scopeId2}><path fill="#10B981" d="M4.5 2A2.5 2.5 0 0 0 2 4.5v7A2.5 2.5 0 0 0 4.5 14h7a2.5 2.5 0 0 0 2.5-2.5v-7A2.5 2.5 0 0 0 11.5 2zm6.354 4.854l-3.5 3.5a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 9.293l3.146-3.147a.5.5 0 0 1 .708.708"${_scopeId2}></path></svg>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div>`);
                    ...
                    createVNode("div", { class: "w-full" }, [
                      ...
                      currentTab.value == "listImage" ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "bg-[#F6F7F7] flex-1 px-6 pt-4" }, [
                          ...
                          imageSelected.value ? (openBlock(), createBlock("img", {
                            key: 0,
                        ...
                        createVNode("div", { class: "w-full md:w-3/4 mt-10 md:mt-0 px-3 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-8" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(images.value, (image) => {
                            return openBlock(), createBlock("div", {
                              onClick: ($event) => imageSelected.value = image,
                              class: [{ "border-4 border-[#10B981]": imageSelected.value == image }, "relative cursor-pointer h-[146px] items-center flex"]
                            }, [
                              createVNode("img", {
                              ...
                              imageSelected.value == image ? (openBlock(), createBlock("svg", {
                                key: 0,
                                class: "absolute right-[2px] top-0",
                                xmlns: "http://www.w3.org/2000/svg",
                                width: "1.5em",
                                height: "1.5em",
                                viewBox: "0 0 16 16"
...
//# sourceMappingURL=MediaLibrary-6fcd5121.mjs.map
