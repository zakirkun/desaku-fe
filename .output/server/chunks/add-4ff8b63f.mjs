...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="grid"><div class="col-12"><div class="card"><h3 class="text-2xl font-medium mb-5">Tambah Berita</h3><div class="grid grid-cols-3 gap-3"><div class="col-span-2">`);
...
//# sourceMappingURL=add-4ff8b63f.mjs.map
