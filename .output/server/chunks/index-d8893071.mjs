...
import { resolveComponent, withCtx, createVNode, openBlock, createBlock, toDisplayString, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_dialog, {
        modelValue: _ctx.modalremoveLembaga,
        "onUpdate:modelValue": ($event) => _ctx.modalremoveLembaga = $event,
        width: "auto"
      }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_card, {
              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${_scopeId2}><span${_scopeId2}>Lembaga yang dihapus tidak bisa dikembalikan kembali.</span></div>`);
                } else {
                  return [
                    createVNode("div", null, [
                      createVNode("span", null, "Lembaga yang dihapus tidak bisa dikembalikan kembali.")
                    ])
                  ];
                }
              }),
      ...
      _push(`<div class="flex justify-between items-center mb-3"><div class="text-2xl font-semibold mb-2">Lembaga</div><div class="text-md font-semibold mb-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/dashboard/lembaga/add" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_btn, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="capitalize"${_scopeId2}>Tambah Lembaga +</span>`);
                } else {
                  return [
                    createVNode("span", { class: "capitalize" }, "Tambah Lembaga +")
                  ];
                }
              }),
              _: 1
      ...
      _push(ssrRenderComponent(_component_v_data_table, {
        ...
        "item.image": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
        ...
        "item.visi": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (value) {
              _push2(`<div${_scopeId}>${ssrInterpolate(value.replace(/(<([^>]+)>)/ig, "").slice(0, 100))}</div>`);
            } else {
              _push2(`<span${_scopeId}>-</span>`);
            }
          } else {
            return [
              value ? (openBlock(), createBlock("div", { key: 0 }, toDisplayString(value.replace(/(<([^>]+)>)/ig, "").slice(0, 100)), 1)) : (openBlock(), createBlock("span", { key: 1 }, "-"))
            ];
          }
        }),
        "item.tugas": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (value) {
              _push2(`<div${_scopeId}>${ssrInterpolate(value.replace(/(<([^>]+)>)/ig, "").slice(0, 100))}</div>`);
            } else {
        ...
        "item.profile": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (value) {
              _push2(`<div${_scopeId}>${ssrInterpolate(value.replace(/(<([^>]+)>)/ig, "").slice(0, 100))}</div>`);
            } else {
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "flex justify-center" }, [
                ...
                createVNode("div", {
                  onClick: ($event) => _ctx.$router.push("/dashboard/lembaga/edit?id=" + item.uuid),
                ...
                createVNode("div", {
                  class: "cursor-pointer",
                  onClick: ($event) => _ctx.openModalremoveLembaga(item.uuid)
                }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    width: "1.5em",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Lembaga/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-d8893071.mjs.map
