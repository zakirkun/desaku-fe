  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(announcements), (announcement) => {
        _push(`<div class="cursor-pointer flex mb-7"><div class="block"><div class="text-lg md:text-xl font-semibold"><span class="line-clamp-2">${ssrInterpolate(announcement.title)}</span></div><div class="text-md flex items-center font-medium mt-2">`);
...
//# sourceMappingURL=index-bc85d83b.mjs.map
