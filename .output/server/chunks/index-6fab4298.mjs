  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_dialog, {
        modelValue: _ctx.modalremovePerangkat,
        "onUpdate:modelValue": ($event) => _ctx.modalremovePerangkat = $event,
        width: "auto"
      }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_card, {
              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${_scopeId2}><span${_scopeId2}>Perangkat Desa yang dihapus tidak bisa dikembalikan kembali.</span></div>`);
                } else {
                  return [
                    createVNode("div", null, [
                      createVNode("span", null, "Perangkat Desa yang dihapus tidak bisa dikembalikan kembali.")
                    ])
                  ];
                }
              }),
      ...
      _push(`<div class="flex justify-between items-center mb-3"><div class="text-2xl font-semibold mb-2">Perangkat Desa</div><div class="text-md font-semibold mb-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/dashboard/perangkat-desa/add" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_btn, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="capitalize"${_scopeId2}>Tambah Perangkat Desa +</span>`);
                } else {
                  return [
                    createVNode("span", { class: "capitalize" }, "Tambah Perangkat Desa +")
                  ];
                }
              }),
              _: 1
      ...
      _push(`</div></div><div class="grid mb-6 animate-fade"><div class="col-12"><div class="card">`);
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "flex justify-center" }, [
                ...
                createVNode("div", {
                  onClick: ($event) => _ctx.$router.push("/dashboard/perangkat-desa/edit?id=" + item.uuid),
                ...
                createVNode("div", {
                  class: "cursor-pointer",
                  onClick: ($event) => _ctx.openModalRemovePerangkat(item.uuid)
                }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    width: "1.5em",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Perangkat-Desa/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-6fab4298.mjs.map
