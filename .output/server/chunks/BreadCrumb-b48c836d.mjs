...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      if (props.child) {
        _push(`<div class="truncate max-[300px]:w-[100px] w-[200px] sm:w-fit"><span class="mx-2">/</span> ${ssrInterpolate(props.child)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=BreadCrumb-b48c836d.mjs.map
