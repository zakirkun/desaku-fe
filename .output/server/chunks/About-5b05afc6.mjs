...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="text-2xl font-semibold mb-2">Tentang Kami</div><div class="grid"><div class="col-12"><div class="card"><h3 class="mb-3 text-xl font-medium">Konten</h3>`);
...
//# sourceMappingURL=About-5b05afc6.mjs.map
