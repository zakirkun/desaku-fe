...
import { ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrRenderAttrs } from 'vue/server-renderer';
              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (currentTab.value == "listImage") {
                    ...
                    _push3(`</div></div><div class="w-full md:w-3/4 md:mt-0 mt-10 px-3 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-8"${_scopeId2}><!--[-->`);
                    ssrRenderList(images.value, (image) => {
                      _push3(`<div class="${ssrRenderClass([{ "border-4 border-[#10B981]": imageSelected.value == image }, "relative rounded-lg cursor-pointer h-[146px] items-center flex"])}"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_v_img, {
                        width: "100%",
                        class: "rounded-md",
                        "aspect-ratio": "1",
                  ...
                  return [
                    createVNode("div", { class: "w-full" }, [
                      ...
                      currentTab.value == "listImage" ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "w-full md:w-3/4 md:mt-0 mt-10 px-3 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-8" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(images.value, (image) => {
                            return openBlock(), createBlock("div", {
                              onClick: ($event) => imageSelected.value = image,
                              class: [{ "border-4 border-[#10B981]": imageSelected.value == image }, "relative rounded-lg cursor-pointer h-[146px] items-center flex"]
                            }, [
...
//# sourceMappingURL=MediaLibrary-4b789d30.mjs.map
