...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="grid grid-cols-1 md:grid-cols-6 md:gap-x-12" data-v-0841d2eb><div class="block col-span-1 md:col-span-4" data-v-0841d2eb><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl sm:text-2xl font-semibold py-3" data-v-0841d2eb><span data-v-0841d2eb>Berita: ${ssrInterpolate(unref(categoryName))} `);
      if (unref(page) != 1) {
        _push(`<span data-v-0841d2eb>: Halaman ${ssrInterpolate(unref(page))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</span></div><!--[-->`);
      ssrRenderList(unref(news), (news2) => {
        _push(`<div class="cursor-pointer animate-fade flex items-center mb-10" data-v-0841d2eb><div class="h-[120px] sm:h-[160px] w-[140px] sm:w-[220px] md:w-[260px] flex-none" data-v-0841d2eb>`);
        ...
        _push(`</div><div class="block pl-4" data-v-0841d2eb><div class="tetx-base md:text-xl font-semibold" data-v-0841d2eb><span class="line-clamp-2" data-v-0841d2eb>${ssrInterpolate(news2.title)}</span></div><div class="text-xs md:text-base block md:flex items-center font-medium mt-2" data-v-0841d2eb><div class="flex" data-v-0841d2eb>`);
        _push(ssrRenderComponent(_component_IconsDate, null, null, _parent));
        _push(`<span class="ml-1 mr-2" data-v-0841d2eb>${ssrInterpolate(unref(moment)(news2.created_at).format("LL"))}</span></div><div class="hidden sm:flex" data-v-0841d2eb>`);
        _push(ssrRenderComponent(_component_IconsTag, null, null, _parent));
        _push(`<span class="ml-1" data-v-0841d2eb>${ssrInterpolate(news2.name)}</span></div></div><div class="mt-2 text-sm md:text-base" data-v-0841d2eb><span class="line-clamp-2 sm:line-clamp-3" data-v-0841d2eb>${ssrInterpolate(news2.description)}</span></div></div></div>`);
      });
      _push(`<!--]-->`);
      ...
      _push(`</div><div class="col-span-2" data-v-0841d2eb>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0841d2eb"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-c30db83e.mjs.map
