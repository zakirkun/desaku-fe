...
import { b as useRouter$1, _ as _export_sfc } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="ml-2"><span class="font-normal">Ditulis oleh</span><span class="ml-1 text-base font-normal">${ssrInterpolate(unref(post).created_by)}</span></div></div><div class="text-md flex items-center font-normal my-4"><div class="flex">`);
...
//# sourceMappingURL=_id_-a92d54f6.mjs.map
