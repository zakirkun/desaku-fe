...
const __default__ = {
  ...
  async mounted() {
    const data = await $fetch(this.$config.public.API_PUBLIC_URL + "/api/admin/" + this.$route.query.id, {
      headers: {
  ...
  methods: {
    async editAdmin() {
      ...
      this.loading = true;
      await $fetch(this.$config.public.API_PUBLIC_URL + "/api/admin/" + this.$route.query.id, {
        method: "PATCH",
        headers: {
          Authorization: "Bearer " + useToken().token
        },
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid animate-fade" }, _attrs))}><div class="col-12"><div class="card"><h3 class="text-2xl font-medium mb-5">Edit Admin</h3>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Admin/edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit-bf1a89c5.mjs.map
