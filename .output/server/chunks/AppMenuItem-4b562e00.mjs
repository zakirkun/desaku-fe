  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<li${ssrRenderAttrs(mergeProps({
        class: { "layout-root-menuitem": __props.root, "active-menuitem": isActiveMenu.value }
      }, _attrs))}>`);
      ...
      if ((!__props.item.to || __props.item.items) && __props.item.visible !== false) {
        _push(`<a${ssrRenderAttr("href", __props.item.url)} class="${ssrRenderClass(__props.item.class)}"${ssrRenderAttr("target", __props.item.target)} tabindex="0"><i class="${ssrRenderClass([__props.item.icon, "layout-menuitem-icon"])}"></i><span class="layout-menuitem-text">${ssrInterpolate(__props.item.label)}</span>`);
      ...
      if (__props.item.to && !__props.item.items && __props.item.visible !== false) {
        _push(ssrRenderComponent(_component_router_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="${ssrRenderClass([__props.item.icon, "layout-menuitem-icon"])}"${_scopeId}></i><span class="layout-menuitem-text"${_scopeId}>${ssrInterpolate(__props.item.label)}</span>`);
              if (__props.item.items) {
              ...
              return [
                createVNode("i", {
                  class: [__props.item.icon, "layout-menuitem-icon"]
                }, null, 2),
                createVNode("span", { class: "layout-menuitem-text" }, toDisplayString(__props.item.label), 1),
...
//# sourceMappingURL=AppMenuItem-4b562e00.mjs.map
