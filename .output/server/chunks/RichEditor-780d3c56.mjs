import { a as useToken } from './server.mjs';
...
const LoadingImage$1 = LoadingImage;
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(QuillEditor), mergeProps({
        content: _ctx.content,
        "onUpdate:content": [($event) => _ctx.content = $event, _ctx.contentChange],
        modules: [_ctx.module, _ctx.formatter],
        contentType: "html",
        placeholder: "Masukkan konten nya disini...",
...
//# sourceMappingURL=RichEditor-780d3c56.mjs.map
